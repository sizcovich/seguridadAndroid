...
\item \textbf{Vulnerabilidad Remota:} Al observar los \texbf{def encrypt(self,value)} y \texbf{def decrypt(self,value)}, notamos que la clave secreta del cipher simétrico se encuentra hardcodeada cuando se crea el vector de inicialización en vez de ser random.
